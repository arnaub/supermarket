...
class Money
  ...
  def self.default_infinite_precision; end
  def self.default_infinite_precision=(arg0); end
  def self.disallow_currency_conversion!; end
  def self.from_amount(amount, currency = nil, options = nil); end
  def self.from_cents(*arg0, **); end
  def self.from_dollars(amount, currency = nil, options = nil); end
  def self.infinite_precision; end
  def self.infinite_precision=(value); end
...
class Money::Allocation
  def self.convert_to_big_decimal(number); end
